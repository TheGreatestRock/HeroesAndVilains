      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            ...
            <v-row>
              <v-text-field label="Organisation's name" v-model="organisationCreation.name" />
            </v-row>
            <v-row>
              <v-text-field label="Organisation's secret" v-model="organisationCreation.secret" />
            </v-row>
          </v-container>
        </v-card-text>
        <v-card-actions>
          <v-spacer/>
          <v-btn color="red darken-1" text @click="showCreateDialog = false; showCreationError = false">
            Cancel
          </v-btn>
